...
class ChillerS2DefaultSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $chiller_default_value->min_model = 100;
        // $chiller_default_value->max_model = 700;
