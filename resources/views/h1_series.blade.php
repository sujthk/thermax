...
<div class="main-body ss-steam-label">
	<div class="page-wrapper max-calculator">
		<div class="page-header">
			<div class="page-body">
				<form id="h1_series" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="row">
...
<script type="text/javascript">
    ...
    var save_report_url = "{{ url('calculators/h1-series/save-report') }}";
    var reset_url = "{{ url('calculators/h1-series/reset-calculate') }}";
    var submit_url = "{{ url('calculators/h1-series/submit-calculate') }}";
    var send_values_url = "{{ url('calculators/h1-series/ajax-calculate') }}";
    ...
    $("#h1_series").submit(function(event) {
