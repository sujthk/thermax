...
-->
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-lg-4">
                                              ...
                                              <div class="col-lg-4">                                              <input type="text" value="" class="form-control" placeholder="Opportunity">
                                             </div>
...
<!--                                                 <label id="model_name"></label>-->
                                             ...
                                             <div class="col-lg-2">                                              <input id="capacity" name="capacity" type="text" value="" onchange="updateModelValues('capacity')" class="form-control">
...
-->
                                     <div class="">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-3">
                                                 <label>Chilled Water Out (min <span id="min_chilled_water_out">0</span>)</label>
                                             </div>
                                             <div class="col-lg-2">
...
-->
                                         ...
                                         <div class="row">
                                             <div class="col-lg-3">
                                                 <label>Cooling Water In (<span id="cooling_water_in_range"></span>)</label>
                                             </div>
                                             <div class="col-lg-2">
                                                 <input type="text" value="" onchange="updateModelValues('cooling_water_in')" name="cooling_water_in" id="cooling_water_in" class="form-control" data-placement="bottom" title="25-36">
                                             ...
                                             <div class="col-lg-2">
                                                 <input type="text" name="cooling_water_flow" onchange="updateModelValues('cooling_water_flow')" id="cooling_water_flow" value="" class="form-control" data-placement="bottom" title="(83.2 - 217.4) (218.2 - 234.9)">
                                         ...
                                         <div class="row">
                                            <div class="col-12">
                                             <label class="">Available Range(s) : <span id="cooling_water_ranges"></span></label>
                                         </div>
                                     </div>
...
-->
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-lg-4 range-hide">
                                                 <input type="text" name="evaporator_thickness" id="evaporator_thickness" onchange="updateModelValues('evaporator_thickness')" value="" class="form-control metallurgy_standard" data-placement="bottom" title="0.57-1.0">
                                             ...
                                             <div class="col-lg-4 range-hide">
                                                 <input type="text" name="absorber_thickness" id="absorber_thickness" onchange="updateModelValues('absorber_thickness')" value="" class="form-control metallurgy_standard" data-placement="bottom" title="0.65-1.0">
                                             ...
                                             <div class="col-lg-4 range-hide">
                                                 <input type="text" name="condenser_thickness" id="condenser_thickness" onchange="updateModelValues('condenser_thickness')" value="" class="form-control metallurgy_standard" data-placement="bottom" title="0.65-1.0">
                                        ...
                                        <div class="col-md-12">
                                         <div class="row">
                                             <div class="col-lg-4 checkbox-fade fade-in-primary">
                                                 <label>
                                                     <input type="checkbox" class="fouling_standard" name="fouling_chilled_water" id="fouling_chilled_water" value="" data-placement="bottom" title="0.00001">
                                                     <span class="cr">
                                                         <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                     </span><span>Chilled Water</span><span id="fouling_chilled_min"></span>
                                                 </label>
                                             </div>

                                             <div class="col-lg-4">
                                                 <input type="text" name="fouling_chilled_value" id="fouling_chilled_value" onchange="updateModelValues('fouling_chilled_value')" class="form-control fouling_standard" data-placement="bottom" title="0.00001">
                                             ...
                                             <div class="col-lg-4 checkbox-fade fade-in-primary">
                                                 <label>
                                                     ...
                                                     <span class="cr">
                                                         <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                     </span><span>Cooling Water</span><span id="fouling_cooling_min"></span>
                                                 </label>
                                             </div>

                                             <div class="col-lg-4">
                                                 <input type="text" name="fouling_cooling_value" id="fouling_cooling_value" onchange="updateModelValues('fouling_cooling_value')" class="form-control fouling_standard" data-placement="bottom" title="0.00001">
                             ...
                             <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-3">
                                                 <input type="text" name="steam_pressure" id="steam_pressure" onchange="updateModelValues('steam_pressure')" value="" class="form-control" data-placement="bottom" title="3.5-10">

                                                 <span class="messages emsg hidden" id="steam_pressure_error">
                                                     <p class="text-danger error">Please Enter a Valid Steam Pressure</p>
                                                 </span>
                                             </div>
                                             <div class="col-lg-3">
