	        ...
	        <div class="page-header">
	            ...
	            <div class="page-header-breadcrumb">
	                <ul class="breadcrumb-title">
	                    ...
	                    <li class="breadcrumb-item"><a href="#!">Group Calculator</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
	                        ...
	                        <div class="card-block">
	                            <div class="dt-responsive table-responsive">
	                                <table id="simpletable" class="table table-striped table-bordered nowrap">
	                                    ...
	                                    <tbody>
	                                    	@php($i=1)
	                                    	@foreach ($group_calculations as $group_calculation) 
	                                    		<tr>
	                                    		    <td>{{ $i }}</td>
	                                    		    <td>{{ $group_calculation->name }}</td>
		                                            <td>
		                                                <a href="{{ url('group-calcluation/edit',[$group_calculation->id]) }}" class="btn btn-primary btn-sm">Edit</a>
		                                            </td> 
	                                    		</tr>
	                                    		@php($i++)
	                                    	@endforeach
