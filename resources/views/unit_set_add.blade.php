	                    ...
	                    <div class="card">
	                        ...
	                        <form id="add_unit_set" method="post" action="{{ url('unit-sets/add') }}" enctype="multipart/form-data">
		                        ...
		                        <div class="card-block">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">TemperatureUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">LengthUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">WeightUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">PressureUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">PressureDropUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">FurnacePressureDropUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">WorkPressureUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">AreaUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">VolumeUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">FlowRateUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">NozzleDiameterUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">CapacityUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">FoulingFactorUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">SteamConsumptionUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">ExhaustGasFlowUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">FuelConsumptionOilUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">FuelConsumptionGasUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">HeatUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">CalorificValueGasUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">CalorificValueOilUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">AllWorkPrHWUnit</label>
		                        	    <div class="col-sm-6">
		                        	...
		                        	<div class="form-group row">
		                        	    <label class="col-sm-2 col-form-label">HeatCapacityUnit</label>
		                        	    <div class="col-sm-6">
