	        ...
	        <div class="page-header">
	            ...
	            <div class="page-header-breadcrumb">
	                <ul class="breadcrumb-title">
	                    ...
	                    <li class="breadcrumb-item"><a href="#!">Add Group Calculation</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
	            ...
	            <div class="row">
	                <div class="col-sm-6">
	                    ...
	                    <div class="card">
	                        ...
	                        <form id="add_user" method="post" action="{{ url('/group-calcluation/install') }}" enctype="multipart/form-data">
                				{{ csrf_field() }}
