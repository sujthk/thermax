...
<div class="main-body ss-steam-label">
    <div class="page-wrapper max-calculator">
        <div class="page-header">
            <div class="page-body">
                <form id="chiller_heater_g2" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
...
<script type="text/javascript">
    ...
    var save_report_url = "{{ url('calculators/chiller-heater-g2-series/save-report') }}";
    var reset_url = "{{ url('calculators/chiller-heater-g2-series/reset-calculate') }}";
    var submit_url = "{{ url('calculators/chiller-heater-g2-series/submit-calculate') }}";
    var send_values_url = "{{ url('calculators/chiller-heater-g2-series/ajax-calculate') }}";
    ...
    $("#chiller_heater_g2").submit(function(event) {
