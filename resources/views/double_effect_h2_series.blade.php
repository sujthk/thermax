													...
													<div class="row">
														...
														<div class="col-md-5">
															<input type="text"
																...
																value="" data-placement="bottom" title="">
														</div>
														<div class="col-md-2" style="padding: 0;">
															<p>({{ $units_data[$unit_set->TemperatureUnit] }})</p>
														</div>
											...
											<div class="row inside-chill">
												<div class="col-md-12">
													<div class="row">
														...
														<div class="col-md-5">
															<p>{{ $language_datas['max_working_pressure'] }} </p>
														</div>
														<div class="col-md-5">
															<input type="text" name="all_work_pr_hw" id="all_work_pr_hw"
																onchange="updateModelValues('all_work_pr_hw')" value=""
																class="form-control" data-placement="bottom"
																data-original-title>
															<span class="messages emsg hidden"
																id="all_work_pr_hw_error">
																<p class="text-danger error"></p>
															</span>
														</div>
														<div class="col-md-2" style="padding: 0;">
															<p>({{ $units_data[$unit_set->AllWorkPrHWUnit] }})</p>
														</div>
													</div>
												</div>
											</div>
...
<script type="text/javascript">
    ...
    var save_report_url = "{{ url('calculators/double-effect-h2/save-report') }}";
    var reset_url = "{{ url('calculators/double-effect-h2/reset-calculate') }}";
    var submit_url = "{{ url('calculators/double-effect-h2/submit-calculate') }}";
    var send_values_url = "{{ url('calculators/double-effect-h2/ajax-calculate') }}";
    ...
    function updateValues() {
		...
		$('.hot_water_out_range').attr('data-original-title',"min "+model_values.min_hot_water_out);
    ...
    function roundValues(){
    	...
    	model_values.all_work_pr_hw = parseFloat(model_values.all_work_pr_hw).toFixed(1);
    	...
    	model_values.min_hot_water_out = parseFloat(model_values.min_hot_water_out).toFixed(1);
