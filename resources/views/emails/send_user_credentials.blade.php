        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mail-back">
                        <div class="mail-logo">
                            <img src="{{asset('mail/images/user_cred.png')}}" alt="email-logo" class="img-fluid">
                        </div>
                        <div class="mail-content">
                            <p>Your iChill account has been created successfully. Please login with the credentials below. Do not forget to change the password after first login.
                            </p>
