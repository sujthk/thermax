...
<div class="img-center" style="font-size:0pt; line-height:0pt; text-align:center "><a href="#" target="_blank"><img src="{{asset('assets/images/thermax-logo.png')}}" border="0" width="103" height="60" alt="" /></a></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="30" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
...
<td>
	...
	<div class="h3-2-center" style="color:#1e1e1e; font-family:Arial, sans-serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center; letter-spacing:5px">FOR YOUR LOGIN OTP!</div>
...
<div class="" style="color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center">Dear {{ $name }}, <strong></strong> </div>
<div class="h3-1-center" style="color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center">Your You have requested the opt . We have generated a One-Time Registration Code for you, this will verify that you have requested access. This One-Time Registration Code is time sensitive and valid for a single use <strong></strong> </div>
			...
			<td align="center" bgcolor="#e10010">
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<td bgcolor="#e10010">
						...
						<span class="link-white" style="color:#ffffff; text-decoration:none">{{ $otp }}</span>
						</div>
					</td>
