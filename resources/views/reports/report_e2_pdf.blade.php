							...
							<thead class="thead-dark">
								<tr>
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px; width: 15%;"
										class="dark-cell font-class" scope="col">{{ $language_datas['client'] }} </td>
									...
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px;"
										...
										Dt: {{ $calculation_values['version_date'] }}</td>
								</tr>
								<tr>
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px;"
						...
						<table class="table table-bordered report-top" style="width: 100%;">
							...
							<tbody>
								...
								<tr>
									...
									<td style="font-weight: bold; font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="dark-cell font-class" scope="col">
										{{ $language_datas['exhaust_gas_circuit'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="dark-cell" scope="col"> </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="dark-cell" scope="col"> </td>
								...
								<tr>
									<td
										...
										2 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['engine_type'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> - </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $calculation_values['engine_type'] }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										3 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['exhaust_gas_flow'] }}(+/-3%)</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->ExhaustGasFlowUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['GEXHAUST'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										4 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['exhaust_gas_in_temp'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['TEXH1'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										5 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['exhaust_gas_out_temp'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['ActExhaustGasTempOut'],1) }}
									</td>
								</tr>
								<tr>
									<td
										...
										6 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['exhaust_connection_diameter'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->NozzleDiameterUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1">
										{{ round($calculation_values['ExhaustConnectionDiameter'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										7 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['exhaust_gas_sp_heat_capacity'] }} </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
								...
								<tr>
									<td
										...
										8 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['exhaust_gas_flow'] }} </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->ExhaustGasFlowUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['ExhaustGasFlowRate'],1) }}
									</td>
								</tr>
								<tr>
									<td
										...
										9 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['percentage_engine_load_considered'] }}
									</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> %</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
								...
								<tr>
									<td
										...
										10 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['pressure_drop'] }} </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->FurnacePressureDropUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['FURNPRDROP'],1) }} </td>
								</tr>
								<tr>
									<td style="padding: 11px;" class="empty-space" colspan="4"></td>
								</tr>
