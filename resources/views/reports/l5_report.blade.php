		      				...
		      				<table class=" table-bordered report-top">
								...
								<tr>
									...
									<tr>
										...
										<td> {{ $language_datas['hot_water_flow'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->FlowRateUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['GHOT'],1) }}</td>
									</tr>
									<tr>
										
										<td> {{ $language_datas['hot_water_inlet_temp'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['THW1'],1) }}</td>
									</tr>
									<tr>
										
										<td> {{ $language_datas['hot_water_outlet_temp'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
									...
									<tr>     
										...
										<td> {{ $language_datas['hot_water_circuit_pressure_loss'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->PressureDropUnit] }}</td>
										<td class="optimal-r1">  {{ round($calculation_values['HotWaterFrictionLoss'],1) }}</td>
									</tr>
									<tr>     
										
										<td>{{ $language_datas['hot_water_connection_diameter'] }} </td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->NozzleDiameterUnit] }}</td>
									...
									<tr>     
										...
										<td> {{ $language_datas['hot_water_glycol'] }} </td>
										<td class="optimal-r1"> % </td>
									...
									<tr>     
										...
										<td> {{ $language_datas['max_working_pressure'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->WorkPressureUnit] }}</td>
										<td class="optimal-r1"> {{ ceil($calculation_values['m_maxHWWorkPressure']) }} </td>
									</tr>
									<tr>     
										
										<td> {{ $language_datas['hot_water_fouling_factor'] }} </td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->FoulingFactorUnit] }}</td>
										@if($calculation_values['TUU'] == "standard")
											<td class="optimal-r1"> {{ $calculation_values['TUU'] }} </td>
										...
										@else
											<td class="optimal-r1"> {{ number_format($calculation_values['FFHOW1'], 5) }} </td>
										@endif
									</tr>
									<tr>
									...
									<tr>
										...
										<td> </td>
										<td class="optimal-r1"> 
											{{ $calculation_values['PowerSupply'] }}
									...
									<tr>
										...
										<td> {{ $language_datas['hp_absorbent_pump_rating'] }}</td>
									...
									<tr>
										...
										<td> {{ $language_datas['lp_absorbent_pump_rating'] }}</td>
										<td class="optimal-r1"> kW (A)</td>
                                        @if($calculation_values['region_type'] == 2)
									...
									<tr>
										...
										<td> {{ $language_datas['generator_tube_material'] }}</td>
										<td> </td>
