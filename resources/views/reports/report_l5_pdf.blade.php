		      			...
		      			<div class="table-responsive">
		      				<table class="table table-bordered report-top">
									...
									<tr>
										...
										<td class="optimal-r1"> {{ round($calculation_values['TCHW1H'],1) }}</td>
									</tr>
									<tr>
										<td> 3 </td> 
										<td class="font-class"> {{ $language_datas['chilled_outlet_temp'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['TCHW2L'],1) }} </td>
									</tr>
									<tr>     
										<td> 4 </td>
									...
									<tr>
										<td> 1 </td>
										<td class="font-class"> {{ $language_datas['heat_rejected'] }}</td>
									...
									<tr>
										...
										<td class="dark-cell font-class" scope="col"> {{ $language_datas['hot_water_circuit'] }}</td>
										<td class="dark-cell" scope="col"> </td>
										<td class="dark-cell" scope="col"> </td>      
									</tr>
									<tr>
										<td> 1 </td>
										<td class="font-class"> {{ $language_datas['heat_input'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->HeatUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['HeatInput'],1) }}</td>
									</tr>
									<tr>
										<td> 2 </td>
										<td class="font-class"> {{ $language_datas['hot_water_flow'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->FlowRateUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['GHOT'],1) }}</td>
									</tr>
									<tr>
										<td> 3 </td>
										<td class="font-class"> {{ $language_datas['hot_water_inlet_temp'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['THW1'],1) }}</td>
									</tr>
									<tr>
										<td> 4 </td>
										<td class="font-class"> {{ $language_datas['hot_water_outlet_temp'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['THW4'],1) }}</td>
									</tr>
									<tr>
										<td> 5 </td> 
									...
									<tr>     
										<td> 7 </td>
										<td class="font-class"> {{ $language_datas['hot_water_connection_diameter'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->NozzleDiameterUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['GENNB'],1) }}</td>
									</tr>
									<tr>     
										<td> 8 </td>
										<td class="font-class"> {{ $language_datas['glycol_type'] }} </td>
									...
									<tr>     
										<td> 9 </td>
										<td class="font-class"> {{ $language_datas['hot_water_glycol'] }} </td>
										<td class="optimal-r1"> % </td>
										<td class="optimal-r1"> {{ round($calculation_values['HWGLY'],1) }} </td>
									</tr>
									<tr>     
										<td> 10 </td>
										<td class="font-class"> {{ $language_datas['max_working_pressure'] }} </td>
									...
									<tr>     
										<td> 11 </td>
										<td class="font-class"> {{ $language_datas['hot_water_fouling_factor'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->FoulingFactorUnit] }}</td>
										@if($calculation_values['TUU'] == "standard")
											<td class="optimal-r1"> {{ $calculation_values['TUU'] }} </td>
									...
									<tr>
										<td> 3 </td>
										<td class="font-class"> {{ $language_datas['hp_absorbent_pump_rating'] }}</td>
										<td class="optimal-r1"> kW (A)</td>
										@if($calculation_values['region_type'] == 2)
                                            <td class="optimal-r1"> {{ round($calculation_values['USA_HPAbsorbentPumpMotorKW'],2) }}( {{ round($calculation_values['USA_HPAbsorbentPumpMotorAmp'],2) }} ) </td>
                                        @else
                                          <td class="optimal-r1"> {{ round($calculation_values['HPAbsorbentPumpMotorKW'],2) }}( {{ round($calculation_values['HPAbsorbentPumpMotorAmp'],2) }} ) </td>
                                        @endif
									</tr>
									<tr>
										<td> 4 </td>
										<td class="font-class"> {{ $language_datas['lp_absorbent_pump_rating'] }}</td>
										<td class="optimal-r1"> kW (A)</td>
										@if($calculation_values['region_type'] == 2)
                                            <td class="optimal-r1"> {{ round($calculation_values['USA_LPAbsorbentPumpMotorKW'],2) }}( {{ round($calculation_values['USA_LPAbsorbentPumpMotorAmp'],2) }} ) </td>
                                        @else
                                          <td class="optimal-r1"> {{ round($calculation_values['LPAbsorbentPumpMotorKW'],2) }}( {{ round($calculation_values['LPAbsorbentPumpMotorAmp'],2) }} ) </td>
                                        @endif
									</tr>
									<tr>
										<td> 5 </td> 
