						...
						<table class="table table-bordered report-top" style="width: 100%;">
							...
							<tbody>
								...
								<tr>
									...
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['TCHW1H'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
									...
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['TCHW2L'],1) }} </td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
								...
								<tr>
									<td
										...
										2 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_flow'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->FlowRateUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['GHOT'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										3 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_inlet_temp'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
								...
								<tr>
									<td
										...
										4 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_outlet_temp'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['THW4'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										5 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['generator_passes'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> No.</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $calculation_values['TGP'] }} +
										{{ $calculation_values['TGP'] }} </td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
										6 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_circuit_pressure_loss'] }}
									</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->PressureDropUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
								...
								<tr>
									<td
										...
										7 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_connection_diameter'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->NozzleDiameterUnit] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['GENNB'],1) }}</td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
								...
								<tr>
									<td
										...
										9 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_glycol'] }} </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> % </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ round($calculation_values['HWGLY'],1) }} </td>
								</tr>
								<tr>
									<td
										style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
								...
								<tr>
									<td
										...
										11 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hot_water_fouling_factor'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $units_data[$unit_set->FoulingFactorUnit] }}</td>
									@if($calculation_values['TUU'] == "standard")
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
									...
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> standard</td>
									@else
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> {{ $calculation_values['FFHOW1'] }}
									</td>
									@endif
								</tr>
								<tr>
								...
								<tr>
									<td
										...
										3 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['hp_absorbent_pump_rating'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> kW (A)</td>
									@if($calculation_values['region_type'] == 2)
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1">
										{{ round($calculation_values['USA_HPAbsorbentPumpMotorKW'],2) }}(
										{{ round($calculation_values['USA_HPAbsorbentPumpMotorAmp'],2) }} ) </td>
									@else
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1">
										{{ round($calculation_values['HPAbsorbentPumpMotorKW'],2) }}(
										{{ round($calculation_values['HPAbsorbentPumpMotorAmp'],2) }} ) </td>
									@endif
								</tr>
								<tr>
									<td
										...
										4 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['lp_absorbent_pump_rating'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> kW (A)</td>
									@if($calculation_values['region_type'] == 2)
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1">
										{{ round($calculation_values['USA_LPAbsorbentPumpMotorKW'],2) }}(
										{{ round($calculation_values['USA_LPAbsorbentPumpMotorAmp'],2) }} ) </td>
									@else
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1">
										{{ round($calculation_values['LPAbsorbentPumpMotorKW'],2) }}(
										{{ round($calculation_values['LPAbsorbentPumpMotorAmp'],2) }} ) </td>
									@endif
								</tr>
								<tr>
									<td
								...
								<tr>
									<td
										...
										4 </td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="font-class"> {{ $language_datas['generator_tube_material'] }}</td>
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"> </td>
									@if($calculation_values['TG2'] == 1)
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
										class="optimal-r1"> Copper </td>
									@else
									<td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
