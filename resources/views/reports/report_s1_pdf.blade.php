...
<head>
	...
	<style>
		...
		.table-responsive .report-top tbody tr th {
			margin-bottom: 20px;
		}
		...
		.report-table .table-responsive .report-top {
			border: 1px solid #242424;
		}

		.report-table .table-responsive .report-top tbody tr {
			border: 1px solid #242424;
		}
	</style>
</head>
						...
						<table class="table table-bordered" style="width: 100%; margin-bottom: 20px;">
							<thead class="thead-dark">
								...
								<tr>
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px;"
										class="dark-cell font-class" scope="col">
										{{ $language_datas['enquiry'] }}</td>
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px;"
										class="dark-cell font-class" scope="col">{{ $phone }}</td>
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px;"
										class="dark-cell font-class" scope="col">
										{{ $language_datas['date'] }}</td>
									<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding-left: 10px;"
						...
						<table class="table table-bordered report-top" style="width: 100%;">
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px;"
										style="text-align: center;" class="dark-cell" class="optimal-r1" scope="col">
								...
								<tr>
									<td style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-weight: bold;
										font-size:15px;" class="dark-cell" scope="col"> A </td>
								...
								<tr>
									<td style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-weight: bold;
										font-size:15px;" class="dark-cell" scope="col"> B </td>
