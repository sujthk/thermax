                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ round($calculation_values['hot_water_in'],1) }}</td>
                                </tr>
                                <tr>
                                    <td
                                        style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
                                    ...
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ round($calculation_values['hot_water_out'],1) }} </td>
                                </tr>
                                <tr>
                                    <td
                                        style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
                                    ...
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> No.</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ round($calculation_values['GeneratorPasses'],1) }} </td>
                                </tr>
                                <tr>
                                    <td
                                        style="text-align: center; font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
                                ...
                                <tr>
                                    ...
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ $units_data[$unit_set->WorkPressureUnit] }}</td>
                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size: 14px;"
                                        class="optimal-r1"> {{ round($calculation_values['all_work_pr_hw'],1) }} </td>
                                </tr>
                                <tr>
                                    <td style="padding: 11px;" class="empty-space" colspan="4"></td>
                                </tr>
                                ...
                                <tr>
                                    <td
                                        style="text-align: center; vertical-align: middle;  font-family:Arial, Helvetica, sans-serif; font-size: 14px;">
                                        1 </td>
