					...
					<div class="table-responsive">
						<table class="table table-bordered" style="width: 100%;">
							<thead class="thead-dark">
								<tr>
									<td class="dark-cell font-class" scope="col" style="padding-right: 40px;">
										{{ $language_datas['client'] }} <span class="cn">:</span> {{ $name }}</td>
									<td class="dark-cell font-class" scope="col">{{ $language_datas['version'] }} :
										5.1.2.0</td>
								</tr>
								<tr>
									<td class="dark-cell font-class" scope="col">{{ $language_datas['enquiry'] }} :
										{{ $phone }}</td>
									<td class="dark-cell font-class" scope="col">{{ $language_datas['date'] }} <span
											class="dn">:</span> {{ date('m/d/Y, h:i A') }}</td>
								</tr>
								<tr>

									<td class="dark-cell font-class" scope="col">{{ $language_datas['project'] }} <span
											class="pn">:</span> {{ $project }}</td>
									<td class="dark-cell font-class" scope="col">{{ $language_datas['model'] }}<span
											class="mn">:</span> {{ $calculation_values['model_name'] }}</td>
								</tr>
							</thead>
						</table>
					</div>
						...
						<table class="table table-bordered report-top">
							...
							<tbody>
								<tr>
									...
									<td class="dark-cell font-class" scope="col">{{ $language_datas['description'] }}
									</td>
									<td class="dark-cell font-class" class="optimal-r1" scope="col">
								...
								<tr>
									...
									<td class="dark-cell" class="optimal-r1" scope="col">
										{{ $units_data[$unit_set->CapacityUnit] }} </td>
									<td class="dark-cell" class="optimal-r1" scope="col">
										{{ $calculation_values['TON'] }}</td>
								</tr>
								<tr>
									<td colspan="4"></td>
								</tr>
								...
								<tr>
									...
									<td class="optimal-r1"> {{ round($calculation_values['ChilledFrictionLoss'],1) }}
									</td>
								</tr>
								<tr>
									<td> 6 </td>
								...
								<tr>
									...
									<td class="optimal-r1"> {{ $units_data[$unit_set->PressureDropUnit] }}</td>
									<td class="optimal-r1"> {{ round($calculation_values['CoolingFrictionLoss'],1) }}
									</td>
								</tr>
								<tr>
									<td> 7 </td>
								...
								<tr>
									...
									<td class="font-class"> {{ $language_datas['max_working_pressure'] }} </td>
									<td class="optimal-r1"> {{ $units_data[$unit_set->WorkPressureUnit] }}</td>
									<td class="optimal-r1"> {{ ceil($calculation_values['m_maxCOWWorkPressure']) }}
									</td>
								</tr>
								<tr>
									<td class="dark-cell" scope="col"> C </td>
									<td class="dark-cell font-class" scope="col"> {{ $language_datas['steam_circuit'] }}
									</td>
									<td class="dark-cell" scope="col"> </td>
									<td class="dark-cell" scope="col"> </td>
								</tr>
								...
								<tr>
									...
									<td class="optimal-r1"> {{ $units_data[$unit_set->NozzleDiameterUnit] }}</td>
									<td class="optimal-r1"> {{ round($calculation_values['SteamDrainDiameter'],1) }}
									</td>
								</tr>
								<tr>
									<td> 7 </td>
								...
								<tr>
									...
									<td class="optimal-r1"> {{ round($calculation_values['TotalPowerConsumption'],1) }}
									</td>
								</tr>
								<tr>
									<td> 3 </td>
									...
									<td class="optimal-r1"> {{ round($calculation_values['AbsorbentPumpMotorKW'],2) }}(
								...
								<tr>
									...
									<td class="dark-cell font-class" scope="col"> {{ $language_datas['physical_data'] }}
									</td>
									<td class="dark-cell" scope="col"> </td>
									<td class="dark-cell" scope="col"> </td>
								</tr>
								...
								<tr>
									...
									<td class="optimal-r1"> {{ $units_data[$unit_set->WeightUnit] }}</td>
									<td class="optimal-r1"> {{ round($calculation_values['MaxShippingWeight'],1) }}
									</td>
								</tr>
								<tr>
									<td> 6 </td>
								...
								<tr>
									<td> 8 </td>
									<td class="font-class"> {{ $language_datas['tube_clearing_space'] }}
								...
								<tr>
									...
									<td class="dark-cell font-class" scope="col">
										{{ $language_datas['low_temp_heat_exchange'] }}</td>
									<td class="dark-cell" scope="col"> </td>
									<td class="dark-cell" class="optimal-r1" scope="col">
										{{ $calculation_values['HHType'] }} </td>
								</tr>
							</tbody>
