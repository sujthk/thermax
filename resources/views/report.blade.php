		      				...
		      				<table class=" table-bordered report-top">
								...
								<tr>
									...
									<tr>
										...
										<th scope="col"> {{ $language_datas['steam_circuit'] }}</th>
										<th scope="col"> </th>
										<th scope="col"> </th>      
									</tr>
									<tr>
									
										<td> {{ $language_datas['steam_pressure'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->PressureUnit] }}</td>
										<td class="optimal-r1"> {{ round($calculation_values['PST1'],1) }}</td>
									</tr>
									<tr>
										
										<td> {{ $language_datas['steam_consumption'] }}(+/-3%)</td>
									...
									<tr>
										...
										<td> {{ $language_datas['condensate_drain_temperature'] }}</td>
										<td class="optimal-r1"> {{ $units_data[$unit_set->TemperatureUnit] }}</td>
