...
-->
            <li data-placement="bottom" title="Dashboard"
                class="nav-item single-item {{ Nav::isRoute('dashboard','has-class') }}">
            ...
            <li data-placement="bottom" title="Users"
                class="nav-item single-item {{ Nav::isRoute('users','has-class') }}">
                <a href="{{ url('/users') }}">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.widget.main"> Users</span>
                </a>
            </li>
            <li data-placement="bottom" title="Calculators"
                class="nav-item single-item {{ Nav::isRoute('calculator-list','has-class') }}">
                <a href="{{ url('/default/calculator-list') }}">
                    <i class="ti-package"></i>
                    <span data-i18n="nav.widget.main"> Calculators</span>
                </a>
            </li>
            <li data-placement="bottom" title="Group Calculator"
                class="nav-item single-item {{ Nav::isRoute('group-calcluation','has-class') }}">
            ...
            <li data-placement="bottom" title="Metallurgies"
                class="nav-item single-item {{ Nav::isRoute('metallurgies','has-class') }}">
            ...
            <li data-placement="bottom" title="Metallurgy Calculators"
                class="nav-item single-item {{ Nav::isRoute('tube-metallurgy/calculators','has-class') }}">
            ...
            <li data-placement="bottom" title="Calculation Values"
                class="nav-item single-item {{ Nav::isRoute('chiller/calculation-values','has-class') }}">
                <a href="{{ url('/chiller/calculation-values') }}">
                    <i class="ti-pulse"></i>
                    <span data-i18n="nav.widget.main"> Calculation Values</span>
                </a>
            </li>
            <li data-placement="bottom" title="Calculation Keys"
                class="nav-item single-item {{ Nav::isRoute('/calculation-keys','has-class') }}">
                <a href="{{ url('/calculation-keys') }}">
                    <i class="ti-panel"></i>
                    <span data-i18n="nav.widget.main"> Calculation Keys</span>
                </a>
            </li>
            <li data-placement="bottom" title="Languages"
                class="nav-item single-item {{ Nav::isRoute('languages','has-class') }}">
                <a href="{{ url('/languages') }}">
                    <i class="ti-layout-menu-v"></i>
                    <span data-i18n="nav.widget.main">Languages</span>
                </a>
            </li>
            <li data-placement="bottom" title="Notes"
                class="nav-item single-item {{ Nav::isRoute('error-notes','has-class') }}">
                <a href="{{ url('/error-notes') }}">
                    <i class="ti-map"></i>
                    <span data-i18n="nav.widget.main"> Notes</span>
                </a>
            </li>
            <li data-placement="bottom" title="Language Notes"
                class="nav-item single-item {{ Nav::isRoute('languages-notes','has-class') }}">
                <a href="{{ url('/languages-notes') }}">
                    <i class="ti-layout-menu-v"></i>
                    <span data-i18n="nav.widget.main">Language Notes</span>
                </a>
            </li>
            <li data-placement="bottom" title="Unit Sets"
                class="nav-item single-item {{ Nav::isRoute('unit-sets','has-class') }}">
                <a href="{{ url('/unit-sets') }}">
                    <i class="ti-id-badge"></i>
                    <span data-i18n="nav.widget.main"> Unit Sets</span>
                </a>
            </li>
            <li data-placement="bottom" title="Region"
                class="nav-item single-item {{ Nav::isRoute('region','has-class') }}">
                <a href="{{ url('/region') }}">
                    <i class="ti-world"></i>
                    <span data-i18n="nav.widget.main">Region</span>
                </a>
            </li>
            <li data-placement="bottom" title="Auto Testing"
                class="nav-item single-item {{ Nav::isRoute('auto-testing','has-class') }}">
                <a href="{{ url('/auto-testing') }}">
                    <i class="ti-eye"></i>
                    <span data-i18n="nav.widget.main">Auto Testing</span>
                </a>
            </li>
            <li data-placement="bottom" title="Calculator Report"
                class="nav-item single-item {{ Nav::isRoute('calculator-reports','has-class') }}">
            ...
            <li data-placement="bottom" title="Versions"
                class="nav-item single-item {{ Nav::isRoute('versions','has-class') }}">
                <a href="{{ url('/versions') }}">
                    <i class="ti-map"></i>
            ...
            <li data-placement="bottom" title="{{ $calculator->display_name }}"
                class="nav-item single-item {{ Nav::isRoute( route($calculator->route),'has-class') }}">
            ...
            <li data-placement="bottom" title="{{ $userCalculator->calculator->display_name }}"
                class="nav-item single-item {{ Nav::isRoute( route($userCalculator->calculator->route),'has-class') }}">
