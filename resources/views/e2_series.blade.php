				...
				<div class="row">
					<div class="col-md-7 padd-2">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="card-header">
									<h5>{{ $language_datas['engine_type'] }}</h5>
								</div>
							</div>
						  	<div class="col-md-6">
							 	<div class="row">
								 	<div class="form-radio col-12">
									 	<div class="radio radio-inline">
											<label>
												<input type="radio" name="engine_type" id="engine_type_gas" value="gas" checked="checked">
												<i class="helper"></i>Gas Fired
											</label>
									 	</div>
									 	<div class="radio radio-inline">
										 	<label>
											 	<input type="radio" name="engine_type" id="engine_type_oil" value="oil">
					 		...
					 		<div class="col-md-12">
					 			<div class="row">
					 				<div class="col-lg-3">
					 					<label>{{ $language_datas['exhaust_gas_in'] }} </label>
					 				</div>
					 				<div class="col-lg-2">
					 					 <input type="text" value="" onchange="updateModelValues('exhaust_gas_in')" name="exhaust_gas_in" id="exhaust_gas_in" class="form-control exhaust_gas_in_range" data-toggle="tooltip" data-animation="false" data-placement="bottom" data-original-title>
					 				</div>
					 				<div class="col-lg-1">
					 					<label>({{ $units_data[$unit_set->TemperatureUnit] }})</label>
					 				</div>
					 				<div class="col-lg-3">
					 					<label>{{ $language_datas['exhaust_gas_out'] }} </label>
					 				</div>
					 				<div class="col-lg-2">
					 					 <input type="text" value="" onchange="updateModelValues('exhaust_gas_out')" name="exhaust_gas_out" id="exhaust_gas_out" class="form-control exhaust_gas_out_range" data-toggle="tooltip" data-animation="false" data-placement="bottom" data-original-title>
					 				</div>
					 				<div class="col-lg-1">
					 					<label>({{ $units_data[$unit_set->TemperatureUnit] }})</label>
					 				</div>
					 				<div class="col-lg-3">
					 					<label>{{ $language_datas['exhaust_gas_flow'] }} </label>
					 				</div>
					 				<div class="col-lg-2">
					 					 <input type="text" name="exhaust_gas_flow" id="exhaust_gas_flow" value="0" onchange="updateModelValues('exhaust_gas_flow')" value="" class="form-control">
					 				</div>
					 				<div class="col-lg-1">
					 					<label>({{ $units_data[$unit_set->ExhaustGasFlowUnit] }})</label>
					 				</div>
					 				<div class="col-lg-3">
					 					<label>{{ $language_datas['exhaust_gas_load'] }} </label>
					 				</div>
					 				<div class="col-lg-2">
					 					 <input type="text" name="exhaust_gas_load" id="exhaust_gas_load" value="0" onchange="updateModelValues('exhaust_gas_load')" value="" class="form-control">
					 				</div>
					 				<div class="col-lg-1">
					 					<label>({{ $units_data[$unit_set->ExhaustGasFlowUnit] }})</label>
					 				</div>
					 				<div class="col-lg-3">
					 					<label>{{ $language_datas['design_load'] }} </label>
					 				</div>
					 				<div class="col-lg-3">
					 					 <input type="text" name="design_load" id="design_load" value="0" onchange="updateModelValues('design_load')" value="" class="form-control">
					 				</div>
									<div class="col-lg-3">
										<label>{{ $language_datas['pressure_drop'] }} </label>
									</div>
									<div class="col-lg-2">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="card-header">
										<h5>{{ $language_datas['economizer'] }}</h5>
									</div>
								</div>
							  	<div class="col-md-6">
								 	<div class="row">
									 	<div class="form-radio col-12">
										 	<div class="radio radio-inline">
												<label>
													<input class="economizer_status" type="radio" name="economizer" id="economizer_yes" value="yes" checked="checked">
													<i class="helper"></i>Yes
												</label>
										 	</div>
										 	<div class="radio radio-inline">
											 	<label>
												 	<input class="economizer_status" type="radio" name="economizer" id="economizer_no" value="no">
												 	<i class="helper"></i>No
											 	</label>
										 	</div>
									 	</div>
