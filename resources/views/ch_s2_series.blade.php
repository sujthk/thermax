										...
										<div class="water-chill">
											...
											<div class="row inside-chill">
												<div class="col-md-12">
													<div class="row">
														<div class="col-md-5">
															<p>{{ $language_datas['pressure'] }} </p>
														</div>
														<div class="col-md-5">
															<input type="text" name="steam_pressure" id="steam_pressure"
																onchange="updateModelValues('steam_pressure')" value=""
																class="form-control steam_pressure_range"
																data-animation="false" data-placement="bottom">
														</div>
														<div class="col-md-2" style="padding: 0;">
															<p>({{ $units_data[$unit_set->PressureUnit] }})</p>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="water-chill">
											...
											<div class="row inside-chill">
												<div class="col-md-12">
													<div class="row">
														<div class="col-md-5">
															<p>{{ $language_datas['heat_duty'] }}</p>
														</div>
														<div class="col-md-5">
															<input type="text" name="heat_duty" id="heat_duty"
																onchange="updateModelValues('heat_duty')" value=""
																class="form-control heat_duty_range"
																data-animation="false" data-placement="bottom">
														</div>
														<div class="col-md-2" style="padding: 0;">
															<p>({{ $units_data[$unit_set->HeatUnit] }})</p>
														</div>
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<input type="text" name="hot_water_in" id="hot_water_in"
																...
																class="form-control hot_water_in_range"
																data-placement="bottom" data-original-title>

															<span class="messages emsg hidden" id="hot_water_in_error">
														...
														<div class="col-md-5">
															<p>{{ $language_datas['hot_water_out'] }}</p>
														</div>
														<div class="col-md-5">
															<input type="text" name="hot_water_out" id="hot_water_out"
																onchange="updateModelValues('hot_water_out')" value=""
																class="form-control hot_water_out_range"
																data-placement="bottom" data-original-title>
														</div>
														<div class="col-md-2" style="padding: 0;">
															<p>({{ $units_data[$unit_set->TemperatureUnit] }})</p>
							...
							<div class="col-sm-12">
								<div class="row">
									<div class="col-md-12 text-center cal-rest">
										<input type="submit" name="submit_value" value="Calculate" id="calculate_button"
											...
											<div class="row">
												...
												<div class="col-md-6">
													<button type="button" name="submit" id="save_word"
														value="Export to Word" class="contact-submit save_report"> <i
															class="fas fa-file-word"></i> Export to Word</button>
												</div>
												<div class="col-md-6">
...
<script type="text/javascript">
	...
	function updateValues() {
		...
		var heat_duty_range = model_values.heat_duty_min+" - "+model_values.heat_duty_max;
		$('.heat_duty_range').attr('data-original-title',heat_duty_range);
	...
	function roundValues(){
		...
		model_values.heat_duty = parseFloat(model_values.heat_duty).toFixed(1);
		model_values.heat_duty_min = parseFloat(model_values.heat_duty_min).toFixed(1);
		model_values.heat_duty_max = parseFloat(model_values.heat_duty_max).toFixed(1);
		model_values.hot_water_in = parseFloat(model_values.hot_water_in).toFixed(1);
		model_values.hot_water_out = parseFloat(model_values.hot_water_out).toFixed(1);
