...
// log::info($this->model_values);
    ...
    public function postShowReport($calculated_values,$name,$project,$phone){
        ...
        $view = view("reports.report_h2", ['name' => $name,'phone' => $phone,'project' => $project,'calculation_values' => $calculation_values,'evaporator_name' => $evaporator_name,'absorber_name' => $absorber_name,'condenser_name' => $condenser_name,'unit_set' => $unit_set,'units_data' => $units_data,'language_datas' => $language_datas])->render();
    ...
    public function downloadReport($user_report_id,$type){
        ...
        $pdf = PDF::loadView('reports.report_pdf_h2', ['name' => $name,'phone' => $phone,'project' => $project,'calculation_values' => $calculation_values,'evaporator_name' => $evaporator_name,'absorber_name' => $absorber_name,'condenser_name' => $condenser_name,'unit_set' => $unit_set,'units_data' => $units_data,'language_datas' => $language_datas,'language' => $language]);
    ...
    public function loadSpecSheetData(){
        ...
        switch ($model_number) {
            case 60:
                ...
                {
                    $this->model_values['model_name'] = "TZC H2 M1";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 M1";
                }
            ...
            case 75:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 M2";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 M2";
                }
            ...
            case 90:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 N1";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 N1";
                }
            ...
            case 110:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 N2";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 N2";
                }
            ...
            case 150:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 N3";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 N3";
                }
            ...
            case 175:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 N4";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 N4";
                }
            ...
            case 210:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 P1";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 P1";
                }
                break;     
            ...
            case 250:
                if ($this->calculation_values['TCHW12'] < 3.5)
                {
                    $this->model_values['model_name'] = "TZC H2 P2";
                }
                else
                {
                    $this->model_values['model_name'] = "TAC H2 P2";
                }
