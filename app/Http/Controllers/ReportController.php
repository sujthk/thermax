...
class ReportController extends Controller
{
    ...
    public function wordFormatL5($user_report_id,$model_code){
        ...
        if($calculation_values['region_type'] ==2){
            ...
            $chilled_table->addCell(1750)->addTextRun($alignment)->addText(htmlspecialchars( round($calculation_values['LPRefrigerantPumpMotorKW'],2) ."( ". round($calculation_values['LPRefrigerantPumpMotorAmp'],2)." )" ));
        }       
        ...
        $chilled_table->addCell(1750)->addText(htmlspecialchars(""));
        $chilled_table->addCell(1750)->addTextRun($alignment)->addText(htmlspecialchars($generator_tube_name));
